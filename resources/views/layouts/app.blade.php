...
<head>
   ...
   <style type="text/tailwindcss">
      ...
      input, textarea {
         @apply shadow-sm w-full border border-slate-200 rounded-md px-3 py-2 text-slate-700 leading-tight focus:outline-none focus:ring-1 focus:ring-slate-500 appearance-none;
      }
